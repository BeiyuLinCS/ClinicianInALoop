...
if __name__== "__main__":
    ...
    for file in glob.glob(os.path.join(finpath, '*/data.al')):
        ...
        if tbname in already_extracted_raw_home_names:
            ...
            foutpath = finpath + tbname + "/raw_no_labelled_data.al"
