...
#		continue
	...
	if os.stat(finpath1).st_size == 0:
		f1 = open(write_Matched_path, 'a')
		os.utime(write_Matched_path, None)
		

		f2 = open(write_Matched_Time_Act, 'a')
		os.utime(write_Matched_Time_Act, None)

		f3 = open(write_Matched_Time_Act1, 'a')
		os.utime(write_Matched_Time_Act1, None)

	if (os.path.isfile(finpath1) and os.stat(finpath1).st_size != 0):
